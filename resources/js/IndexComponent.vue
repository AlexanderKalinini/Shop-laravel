...
<template>
    <main class="py-16 lg:py-20">
        <div class="container">
            <section>
                <!-- Section heading -->
                <h2 class="text-lg font-black lg:text-[42px]">
                    Наши преимущества
                </h2>

                <!-- Advantages -->
                <div
                    class="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 md:gap-6 2xl:grid-cols-4"
                >
                    <div
                        class="flex flex-col items-center gap-2 rounded-xl bg-purple px-4 py-6 text-center text-white md:px-6 md:py-8"
                    >
                        <svg
                            class="h-10 w-10 opacity-40 md:h-12 md:w-12"
                        ...
                        <h5 class="pt-2 text-sm font-bold md:pt-4 md:text-md">
                            Бесплатная доставка
                        </h5>
            ...
            <section class="mt-16 lg:mt-24">
                ...
                >
                    @include('parts/products/1') @include('parts/products/2')
                    @include('parts/products/3') @include('parts/products/4')
                    @include('parts/products/5') @include('parts/products/6')
                    @include('parts/products/7') @include('parts/products/8')
                </div>

                <div class="mt-12 text-center">
                    <a href="catalog.html" class="btn btn-purple"
                        >Все товары &nbsp;→</a
                    >
                </div>
            </section>
