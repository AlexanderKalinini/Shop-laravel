        ...
        <main class="py-16 lg:py-20">
            <div class="container">
                ...
                <ul class="breadcrumbs flex flex-wrap gap-y-1 gap-x-4 mb-6">
                    ...
                    <li>
                        <span class="text-body text-xs">Корзина покупок</span>
                    </li>
                </ul>
                ...
                <section>
                    ...
                    <!-- Message -->
                    <div
                        class="lg:hidden py-3 px-6 rounded-lg bg-pink text-white"
                    >
                        ...
                        >
                            ...
                            <tbody>
                                <tr>
                                    <td
                                        scope="row"
                                        class="py-4 px-4 md:px-6 rounded-l-2xl bg-card"
                                    >
                                        <div
                                    ...
                                    <td
                                        class="py-4 px-4 md:px-6 rounded-r-2xl bg-card"
                                    >
                                        <a
                                            href="#"
