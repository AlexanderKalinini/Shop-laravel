                            ...
                            <div class="space-y-3">
                                ...
                                <div x-data="{ createAccount: false }">
                                    <div class="py-3 text-body">
                                        Вы можете создать аккаунт после
                                        оформления заказа
                                    </div>
                        ...
                        <div class="p-6 2xl:p-8 rounded-[20px] bg-card">
                            ...
                            >
                                <thead class="text-[12px] text-body uppercase">
                                    <th
                                        scope="col"
                                        class="pb-2 border-b border-body/60"
                                    >
                                        Товар
                                    </th>
                                    <th
                                        scope="col"
                                        class="px-2 pb-2 border-b border-body/60"
                                    >
                                        К-во
                                    </th>
                                    <th
                                ...
                                <tbody>
                                    <tr>
                                        <td
                                            scope="row"
                                            class="pb-3 border-b border-body/10"
                                        >
                                            <h4 class="font-bold">
                                                <router-link
                                                    :to="{
