            ...
            <div class="container">
                <section>
                    ...
                    >
                        ...
                        >
                            ...
                            <h5
                                class="pt-2 text-sm font-bold md:pt-4 md:text-md"
                            >
                                Бесплатная доставка
                            </h5>
                ...
                <section class="mt-16 lg:mt-24">
                    ...
                    >
                        ...
                        <router-link
                            to="catalog.html"
                            class="rounded-xl bg-card p-3 text-xxs font-semibold text-white hover:bg-pink sm:p-4 sm:text-xs lg:text-sm 2xl:p-6"
                            >Наушники</router-link
                        >
                        <router-link
                            to="catalog.html"
                            class="rounded-xl bg-card p-3 text-xxs font-semibold text-white hover:bg-pink sm:p-4 sm:text-xs lg:text-sm 2xl:p-6"
                            >Поверхности</router-link
                        >
                        <router-link
                            to="catalog.html"
                            class="rounded-xl bg-card p-3 text-xxs font-semibold text-white hover:bg-pink sm:p-4 sm:text-xs lg:text-sm 2xl:p-6"
                        ...
                        <router-link
                            to="catalog.html"
                            class="rounded-xl bg-card p-3 text-xxs font-semibold text-white hover:bg-pink sm:p-4 sm:text-xs lg:text-sm 2xl:p-6"
                            >Акустика</router-link
                        >
                        <router-link
                            to="catalog.html"
                            class="rounded-xl bg-card p-3 text-xxs font-semibold text-white hover:bg-pink sm:p-4 sm:text-xs lg:text-sm 2xl:p-6"
                            >Аксесуары</router-link
                        >
                        <router-link
                            to="catalog.html"
                            class="rounded-xl bg-card p-3 text-xxs font-semibold text-white hover:bg-pink sm:p-4 sm:text-xs lg:text-sm 2xl:p-6"
                            >Распродажа</router-link
                        >
                    </div>
                </section>
                ...
                <section class="mt-16 lg:mt-24">
                    ...
                    <div class="mt-12 text-center">
                        <router-link to="catalog.html" class="btn btn-purple"
