        ...
        <main class="py-16 lg:py-20">
            <div class="container">
                ...
                <ul class="breadcrumbs flex flex-wrap gap-y-1 gap-x-4 mb-6">
                    ...
                    <li>
                        <span class="text-body text-xs"
                            >Заказ №4820 успешно оформлен</span
                        >
                    </li>
                </ul>
                ...
                <section>
                    ...
                    >
                        <h1
                            class="pb-4 2xl:pb-0 text-lg lg:text-[42px] font-black"
                        >
                    ...
                    <!-- Message -->
                    <div
                        class="md:hidden py-3 px-6 rounded-lg bg-pink text-white"
                    >
                        ...
                        >
                            ...
                            <tbody>
                                <tr>
                                    <td
                                        scope="row"
                                        class="py-4 px-6 rounded-l-2xl bg-card"
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            <div class="py-3">
                                                <h4
                                                    class="text-xs sm:text-sm xl:text-md font-bold"
                                                >
                                                    <a
                                                        href="product.html"
                        ...
                        <table class="w-full text-left">
                            <tbody>
                                ...
                                <tr>
                                    <th
                                        scope="row"
                                        class="text-md 2xl:text-lg font-black"
                                    >
                                        Итого:
                                    </th>
