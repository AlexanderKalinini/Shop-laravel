    ...
    <LayoutComponent>
        <main class="py-16 lg:py-20">
            <div class="container">
                ...
                <!-- Main product -->
                <section
                    class="flex flex-col lg:flex-row gap-10 xl:gap-14 2xl:gap-20 mt-12"
                >
                    ...
                    <div class="basis-full lg:basis-3/5 xl:basis-2/4">
                        <div class="grow flex flex-col lg:py-8">
                            <h1
                                class="text-lg md:text-xl xl:text-[42px] font-black"
                            >
                            ...
                            <div class="flex items-baseline gap-4 mt-4">
                                <div
                                    class="text-pink text-lg md:text-xl font-black"
                                >
                                    43 900 ₽
                                </div>
                                <div
                            ...
                            <ul class="sm:max-w-[360px] space-y-2 mt-8">
                                <li class="flex justify-between text-body">
                                    <strong class="text-white">Вес (г):</strong>
                                    92
                                </li>
                                <li class="flex justify-between text-body">
                            ...
                            <form class="space-y-8 mt-8">
                                ...
                                >
                                    ...
                                    <a
                                        href="#"
                                        class="w-[68px] !px-0 btn btn-purple"
                                        title="В избранное"
                                    >
                                        <svg
                                            class="w-5 h-5"
                ...
                <!-- Description -->
                <section
                    class="mt-12 xl:mt-16 pt-8 lg:pt-12 border-t border-white/10"
                >
                    <h2 class="mb-12 text-lg lg:text-[42px] font-black">
                        Описание
                    </h2>
                    <article class="text-xs md:text-sm">
                        ...
                        <ul class="mb-12 list-outside space-y-3">
                            <li>
                                Сверхлегкий корпус весом 57 грамм для быстрого
                                игрового процесса.
                            </li>
                            <li>
                                Съемный кабель Super Mesh USB-C для уменьшения
                                сопротивления.
                            </li>
                            <li>
                                Отлично скользящие глайды из PTFE для плавных
                                движений мыши.
                            </li>
                            <li>
                                Оптический игровой сенсор TrueMove Core с
                                технологией Pixel perfect.
                            </li>
                            <li>
                                AquaBarrier™ для водонепроницаемости, защиты от
                        ...
                        <p class="mb-12">
                            Aerox 3 оптимизирована для получения самых быстрых
                            движений в играх, поэтому вы всегда на шаг впереди
                            конкурентов. Когда на счету миллисекунды, скорость
                            имеет значение.
                        </p>
                        <h5 class="mb-4 text-md text-md lg:text-lg font-black">
                            УЛЬТРАЛЕГКАЯ - 57 ГРАММ
                        </h5>
                        <p class="mb-12">
                            Уникальный перфорированный внешний корпус и
                            уменьшенная электроника - все это с высокой
                            точностью спроектировано так, чтобы обеспечить
                            потрясающе легкий вес и новый уровень прочности.
                        </p>
                    </article>
                </section>
