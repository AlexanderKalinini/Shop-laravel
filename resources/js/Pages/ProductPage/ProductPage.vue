<script>
import ProductsTile from "../../Pages/CatalogPage/Components/ProductsTile.vue";
...
import Favorit from "../../../helpers/Favorit.js";
  ...
  methods: {
    getIdsFromSession() {
      ...
      for (let key in sessionStorage) {
        if (sessionStorage.hasOwnProperty(key) && key.startsWith("also")) {
          ids.add(sessionStorage.getItem(key));
        }
      }
      return [...ids];
    },
    ...
    <main class="py-16 lg:py-20">
      <div class="container">
        ...
        <section class="mt-16 xl:mt-24">
          ...
          <!-- Products list -->
          <ProductsTile :products="seenProducts" />
        </section>
      </div>
    </main>
  </LayoutComponent>
