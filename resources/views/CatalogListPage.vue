        ...
        <main class="py-16 lg:py-20">
            <div class="container">
                ...
                <section class="mt-16 lg:mt-24">
                    <!-- Section heading -->
                    <h2 class="text-lg lg:text-[42px] font-black">
                        Каталог товаров
                    </h2>

                    <div
                        class="flex flex-col lg:flex-row gap-12 lg:gap-6 2xl:gap-8 mt-8"
                    >
                        <!-- Filters -->
                        <aside class="basis-2/5 xl:basis-1/4">
                            ...
                            >
                                ...
                                <div>
                                    <h5
                                        class="mb-4 text-sm 2xl:text-md font-bold"
                                    >
                                        Цена
                                    </h5>
                                    <div
                                    ...
                                    >
                                        <span
                                            class="text-body text-xxs font-medium"
                                            >От, ₽</span
                                        >
                                        <span
                                            class="text-body text-xxs font-medium"
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        />
                                        <span
                                            class="text-body text-sm font-medium"
                                            >–</span
                                        >
                                        <input
                                            type="number"
                        ...
                        <div class="basis-auto xl:basis-3/4">
                            ...
                            >
                                <div class="flex items-center gap-4">
                                    ...
                                    <div
                                        class="text-body text-xxs sm:text-xs !leading-5"
                                    >
                                        Найдено: <strong>25 товаров</strong>
                                    </div>
                                </div>
                                <div
